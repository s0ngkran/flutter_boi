...
import '../response_model/create_board_req.dart';
import '../response_model/update_board_req.dart';
import 'base_provider.dart';

class ApiProviderRest extends BaseProviderRest {
  // Future<Response> register(String path, RegisterRequest data) {
  //   return post(path, data.toJson());
  // }

  Future<MyResponse> getBoard() {
    return get(
      '/board/',
      auth: false,
    );
  ...
  Future<MyResponse> createBoard(CreateBoardReq req) {
    return post(
      '/board/',
      req.toMap(),
      auth: false,
  ...
  Future<MyResponse> updateBoard(UpdateBoardReq req) {
    return post(
      '/board/',
      req.toMap(),
      auth: false,
